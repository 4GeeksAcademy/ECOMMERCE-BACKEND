...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Order_Hamburger, db.session))
    admin.add_view(ModelView(Order_Beverage, db.session))
    admin.add_view(ModelView(Order_Acompañamiento, db.session))
